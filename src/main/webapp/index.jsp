	...
	<div class="container">
		<div class="no-gutter row">
	  		...
	  		<div class="col-md-2">
	                ...
	                <div class="panel-heading" style="background-color:#00b900; color:#fff;">
	                	Top Hospitals
	                </div>
		           ...
		           <div class="panel-body">
		                  <form role="form" action="predict" method="post">
							<div class="form-group">
								<p><label for="comment" id="user_suggestion">Write your problem separated by comma ",". For best result avoid spelling mistakes. Include as much symptoms as possible.</label></p>
								<textarea  class="form-control"  rows="10" cols="40" name="userInput" placeholder="How are you feeling?" required="required"></textarea><br />
								<p><label for="comment" id="user_example"><lead>Example:</lead> I am having high fever, I have chest pain, my head is paining, dry cough some times...</label></p>
								<input class="btn btn-lg btn-success center-block" type="submit" value="predict" />
								</div>
							</form>
		                  ...
		                  <div>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Jaundice</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Cholera</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Ebola</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Hiv</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Cancer</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Hepatitis</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Typhoid</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Diabetis</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Malaria</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Sugar</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Blood cancer</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Tuberclosis</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> New</a></h5>
			                  <h5><a href="#"><i class="glyphicon glyphicon-info-sign"></i> Diabetis</a></h5>
		                  	<hr>
		                 </div> 
		               </div> 
